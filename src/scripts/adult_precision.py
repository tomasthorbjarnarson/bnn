...
time = 10*60
seeds = [947693273,173243275,4316528746]
hl_neurons = 16
focus = 1
...
def adult_precision(losses, plot=False):
  ...
  json_dir = "results/json/adult_precision"
  ...
  ylabel = "Accuracy %"
  plot_title = "Train accuracies for loss %s on Adult Dataset for different precisions" % loss
  plot_dir = "results/plots/adult_precision/%s"
  plot_results(all_results, "train_accs", bounds, 1, ylabel, plot_title, plot_dir % "train_acc", file_name)

  plot_title = "Test accuracies for loss %s on Adult Dataset for different precisions" % loss
  plot_results(all_results, "test_accs", bounds, 2, ylabel, plot_title, plot_dir % "test_acc", file_name)

  ylabel = "Runtime [s]"
  plot_title = "Runtimes for loss %s on Adult Dataset for different precisions" % loss
